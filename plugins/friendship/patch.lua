...
pos1=offsets.find(myp,0x39,ANYBYTE,0x8c,00,00,00,EOL) -- compare [reg+08c] (creature race) with any reg 
pos2=offsets.find(myp,0x3b,ANYBYTE,0x8c,00,00,00,EOL) -- compare  any reg with [reg+08c] (creature race)
pos=minEx(pos1,pos2)
if pos ~=0 then
	
	if(pos-p>250) then
		--this here does not work yet...
		--[[pos =offsets.find(p,CALL,EOL)
